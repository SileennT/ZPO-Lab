...
public class PolEngTest extends Application {
    ...
    public void Start() {
        ...
        for (Question q : questions) {
            ...
            dialog.setHeaderText(q.Pol);
            //String answer = scan.nextLine();
            Optional <String> putText = dialog.showAndWait();
            if(putText.isPresent()) {
                String answer = putText.get();
                for (String e : q.Eng) {
